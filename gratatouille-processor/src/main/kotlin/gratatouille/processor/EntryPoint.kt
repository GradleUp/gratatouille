...
internal fun GTaskAction.entryPoint(): FileSpec {
    ...
    val fileSpec = FileSpec.builder(className)
        .addAnnotation(suppressInternalAnnotationSpec)
        .addType(
...
internal fun Property.toTypeName(): TypeName {
    return when (type) {
        ...
        InputFiles -> ClassName("kotlin.collections", "Set").parameterizedBy(ClassName("java.io", "File"))
            ...
            CodeBlock.builder()
                ...
                .apply {
                    this@funSpec.parameters.forEach {
                        val extra = if (it.type is KotlinxSerializableInput) {
